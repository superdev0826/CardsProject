  ...
  return (
    <div className="container">
      <form
        ...
        className="col-lg-6 mx-auto shadow p-3 rounded mt-3"
      >
        ...
        <div>
          ...
          {errors.password && (
            <span className="text-danger">Enter min 3 charts password</span>
          )}
        </div>
        <div>
          ...
          {errors.fullName && (
            <span className="text-danger">Enter min 2 charts name</span>
          )}
        </div>
        <div className="mt-2">
          <input
